...
const buildTimesChartsRouter = require('./routers/buildTimesChartsRouter');
const buildResultsChartsRouter = require('./routers/buildResultsChartsRouter');
const testResultsChartsRouter = require('./routers/testResultsChartsRouter');
