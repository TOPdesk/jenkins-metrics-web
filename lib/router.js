...
function* getEarliestTestResultsDistributionChart(next) {
  try {
    const result = yield provider.getEarliestTestResultDistribution(this.rdbConn, this.params.jobName);
    yield charts.renderTestResultDistribution(this, result,
...
router.get('/:jobName/charts/earliesttestresultdistribution', getEarliestTestResultsDistributionChart);
