...
function* getExecutionTimeAverages(conn, jobName) {
  return {
    overall: yield getAverageExecutionTime(conn, jobName),
    earliest: yield getEarliestAverageExecutionTime(conn, jobName),
    latest: yield getLatestAverageExecutionTime(conn, jobName)
  };
}
