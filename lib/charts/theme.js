...
function testResultToBackgroundColor(result) {
  switch (result) {
    case 'FAILED':
      return POMEGRANATE;
    case 'SUCCESSFUL':
...
function testResultToHoverBackgroundColor(result) {
  switch (result) {
    case 'FAILED':
      return ALIZARIN;
    case 'SUCCESSFUL':
...
module.exports = {
  ...
  testResultToBackgroundColor,
  testResultToHoverBackgroundColor
};
